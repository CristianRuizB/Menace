		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-info" href="<?php echo "imprimirTicket.php?codigo=" . $venta->codigo?>"><i class="fa fa-print"></i></a></td>
